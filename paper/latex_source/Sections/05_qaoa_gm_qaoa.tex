...
Let $\mathcal F$ be the feasible set. \GMQAOA{} assumes a unitary $U_S$ satisfying
\begin{equation}
...
\end{equation}
The theoretical construction remains inside $\mathcal F$, and equal-quality feasible solutions receive equal amplitudes \cite{baertschi2020}.
