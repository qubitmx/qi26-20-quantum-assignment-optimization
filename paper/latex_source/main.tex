...
\author{
Iván Barrientos Salas\thanks{Corresponding author and QI26-20 mentor.} \and
Jiya Maurya \and
Qyngshuq \and
Abhishek Raj \and
Satkar Juneja \and
MarcosJ \and
Ilia Fazeli\\[0.5em]
\small QI26-20 / QIntern 2026 Research Team
}
...
\input{Sections/03_qubo_formulation}
\input{Sections/04_classical_baselines}
\input{Sections/05_qaoa_gm_qaoa}
...
\clearpage
\appendix
\input{Appendices/appendix_a_compliance}
\input{Appendices/appendix_b_circuits}
\input{Appendices/appendix_c_distributions}
\input{Appendices/appendix_d_reproducibility}
